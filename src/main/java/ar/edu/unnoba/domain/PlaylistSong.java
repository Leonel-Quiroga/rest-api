...
public class PlaylistSong implements Serializable {
	...
	@Id	@GeneratedValue(generator = "playlist_song_seceunce", strategy = GenerationType.SEQUENCE)
	@SequenceGenerator(name = "playlist_song_seceunce", sequenceName = "playlist_song_seceunce", allocationSize = 1)
	@Column(name = "id")
	private Integer id;
